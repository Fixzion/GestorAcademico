...
# Cargar las variables de entorno apuntando específicamente al archivo en la raíz
...
if __name__ == "__main__":
    print(f"--- Verificando Configuración en /src ---")
    ...
    if ruta:
        ...
        print("⚠️ Hay un problema con la configuración. Revisa tu archivo .env en la raíz.")